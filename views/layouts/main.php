...
<body class="page-bg page-branding_l <? if(isset($this->context->body_id)) echo $this->context->body_id; ?>" id="" style="background-image: url('/img/branding-new.jpg'); background-color: #ba1a1d">
<?php $this->beginBody() ?>
